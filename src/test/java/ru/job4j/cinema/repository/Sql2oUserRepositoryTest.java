...
class Sql2oUserRepositoryTest {
    ...
    void whenSaveThenGetSame() {
        var user1 = sql2oUserRepository.save(
                new User(0, "user1", "user1@mail.ru", "password1")).get();
    ...
    void whenSaveSeveralThenGetAll() {
        ...
        var user2 = sql2oUserRepository.save(
                new User(0, "user2", "user2@mail.ru", "password2")).get();
        var user3 = sql2oUserRepository.save(
                new User(0, "user3", "user3@mail.ru", "password3")).get();
    ...
    public void whenDeleteThenGetEmptyOptional() {
        ...
        var savedVacancy = sql2oUserRepository.findByEmailAndPassword("user1@mail.ru", "password1");
